...
namespace  Aspose.OCR.Live.Demos.UI.Models
{
	...
	public abstract class AsposeOCRBase : ApiController
    {
		///<Summary>
		/// ActionDelegate
		///</Summary>
      ...
      bool deleteSourceFolder = true, string zipFileName = null)
		...
		protected async Task<Response> Process(string modelName, string fileName, string folderName,  string methodName, inFileActionDelegate action)
        {           
